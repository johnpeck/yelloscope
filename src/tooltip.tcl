...
#Tooltip procedures are based on http://wiki.tcl.tk/1954
...
proc setTooltip {widget text} {
 ...
 setTooltip [wave::getWavePath].off.offValue "Left click and drag this slider to adjust the output waveform frequency,\n between the frequencies set in the Maximum Frequency display\n at the top and the Minimum Frequency display at the bottom.\n  Left click in the trough above the slider or below the slider to make a one-step adjustment.\n  The variation of frequency vs slider position (linear or logarithmic)\n is set by the 'Sweep Mode' control.\n Frequency can also be set directly by clicking on the current frequency display."
